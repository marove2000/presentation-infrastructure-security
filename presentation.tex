...
\begin{columns}[T,c,onlytextwidth]
	...
	\end{figure}
\end{columns}
\href{https://de.wikipedia.org/wiki/RAID}{https://de.wikipedia.org/wiki/RAID}}
\end{frame}
...
\end{figure}
\blfootnote{Bild: \href{https://www.ssllabs.com/ssltest}{https://www.ssllabs.com/ssltest}}
\end{frame}
